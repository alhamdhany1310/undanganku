...
export const guest = (() => {
  ...
  const buildGoogleCalendar = () => {
    ...
    const data = new URLSearchParams({
      action: "TEMPLATE",
      text: "The Wedding of Maspuk and Azarima",
      dates: `${formatDate("2025-11-01 08:30")}/${formatDate(
        "2025-11-01 13:00"
      )}`,
      details:
      ...
      location:
        "LKSA PA NW Lengkok, Dusun Lengkok Lendang, Desa Tembeng Putik, Kec. Wanasaba, Kab. Lombok Timur, Nusa Tenggara Barat 83653",
      ctz: config.get("tz"),
    });
