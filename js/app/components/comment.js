...
export const comment = (() => {
  ...
  const onNullComment = () => {
    const desc = lang
      .on(
        "id",
        "📢 Hari ini, satu dari 365 hari yang ada, kami akan memulai babak baru. Kami berharap kamu bisa menjadi saksi dan bagian dari kebahagiaan kami. 🎉"
      )
      .on(
        "en",
        "📢 Today, one out of the 365 days in a year, marks the beginning of a new chapter. We hope you can be a witness and a part of our happiness. 🎉"
      )
      .get();
